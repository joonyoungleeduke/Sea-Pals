...
import { SafeAreaView, StyleSheet, Text, TouchableWithoutFeedback, View, Modal, TouchableOpacity, Image} from 'react-native';
...
export default function TurtlePage({route}) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* profile button */}
      <TouchableOpacity 
        style={styles.lvlSuperContainer} 
      ...
      >
        <View style={styles.lvlContainer}>
         <MaterialCommunityIcons name="turtle" color="white" size={60} />
        </View>
      </TouchableOpacity>
      ...
      {/* turtle display */}
      <Turtle top="10%"/>
      <Text style={styles.age}>2 Days Old</Text>
